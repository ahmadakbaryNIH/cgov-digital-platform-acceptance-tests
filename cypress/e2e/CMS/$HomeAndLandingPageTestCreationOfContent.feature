...
Scenario: Add Secondary Feature Card Row
    ...
    And user fills out the following fields
        | fieldLabel        | value                                  | field_name                                                                                           |
        | Featured Item Url | https://www.google1.com                | field_landing_contents[1][subform][field_row_cards][1][subform][field_featured_url][0][uri]          |
        | Card Title        | Google Link Secondary Feature Card Row | field_landing_contents[1][subform][field_row_cards][1][subform][field_override_card_title][0][value] |
    When user saves the content page
...
Scenario: Add List
    ...
    And user fills out the following fields
        | fieldLabel | value                   | field_name                                                                                       |
        | Link       | https://www.google2.com | field_landing_contents[1][subform][field_list_items][1][subform][field_external_link][0][uri]    |
        | Title      | Google Link List Item   | field_landing_contents[1][subform][field_list_items][1][subform][field_override_title][0][value] |
    ...
    And user fills out the following fields
        | fieldLabel     | value                                | field_name                                                                                       |
        | Override Title | Media Link Override Title List Items | field_landing_contents[1][subform][field_list_items][2][subform][field_override_title][0][value] |
    When user saves the content page
 ...
 Scenario: Add One and two column containers
    ...
    And user fills out the following fields
        | fieldLabel | value                      | field_name                                                            |
        | Title      | One Column Container Title | field_landing_contents[1][subform][field_container_heading][0][value] |
    And user clicks on "Add Content Block" option to "Main Contents" within "One Column Container" section
    And user fills out the following fields
        | fieldLabel      | value                                | field_name                                                                                           |
        | Content Heading | Content Heading One Column Container | field_landing_contents[1][subform][field_main_contents][0][subform][field_content_heading][0][value] |
    And user fills out HTML Content text area with "This is Html content for Content Block in One Column Container"
    And user clicks on "Add List" option to "Main Contents" within "One Column Container" section  
    And user fills out the following fields
        | fieldLabel | value                                | field_name                                                            |
        | Title      | List Item Title One Column Container | field_landing_contents[1][subform][field_container_heading][0][value] |
    ...
    And user fills out the following fields
        | fieldLabel | value                            | field_name                                                                                                                        |
        | Link       | https://www.google3.com          | field_landing_contents[1][subform][field_main_contents][1][subform][field_list_items][1][subform][field_external_link][0][uri]    |
        | Title      | Google Link One Column Container | field_landing_contents[1][subform][field_main_contents][1][subform][field_list_items][1][subform][field_override_title][0][value] |
    ...
    And user fills out the following fields
        | fieldLabel      | value                                | field_name                                                                                           |
        | Content Heading | Content Heading Two Column Container | field_landing_contents[2][subform][field_main_contents][1][subform][field_content_heading][0][value] |
    And user fills out HTML Content text area with "This is Html content for Content Block Two Column"
    And user clicks on "Add Dynamic List" option to "Main Contents" within "One Column Container" section
    And user fills out the following fields
        | fieldLabel | value              | field_name                                                                                      |
        | List Title | Dynamic List Title | field_landing_contents[1][subform][field_main_contents][3][subform][field_list_title][0][value] |
...
Scenario: Add Borderless Full-Width Card
    ...
    And user fills out the following fields
        | fieldLabel                       | value                                                | field_name                                                                      |
        | Override Card Title              | Override title for Borderless Card                   | field_landing_contents[1][subform][field_override_card_title][0][value]         |
        | Longer Override Card Description | Longer Override Card Description for Borderless Card | field_landing_contents[1][subform][field_override_card_longer_descr][0][value]  |
        | Button Text                      | Button text for Borderless Full-Width Card           | field_landing_contents[1][subform][field_button_text][0][value]                 |
        | Button Alt Text                  | Button Alt text for Borderless Full-Width Card       | field_landing_contents[1][subform][field_button_alt][0][value]                  |
    When user saves the content page
...
Scenario: Add Title First Feature Card Row
    ...
    And user fills out the following fields
        | fieldLabel        | value                                | field_name                                                                                                         |
        | Featured Item Url | https://www.google6.com              | field_landing_contents[1][subform][field_two_column_feature_card][0][subform][field_featured_url][0][uri]          |
        | Card Title        | Google Link Title First Feature card | field_landing_contents[1][subform][field_two_column_feature_card][0][subform][field_override_card_title][0][value] |
